...
/**
 * Provides conversion from int ids coming from the tracker to Uuid ids that are
...
namespace std {
template<>
struct less<const sample_company::vms_server_plugins::opencv_object_detection::
              CompositeDetectionId>
{
  bool operator()(
    const sample_company::vms_server_plugins::opencv_object_detection::
      CompositeDetectionId & lhs,
    const sample_company::vms_server_plugins::opencv_object_detection::
      CompositeDetectionId & rhs
  ) const
  {
